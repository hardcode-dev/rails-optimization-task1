...
def work(disable_gc: false, disable_bar: false)
  GC.disable if disable_gc

  users = Parsing.new(FILE_NAME, disable_bar).call
  report = Report.new(users, disable_bar).call
...
')
  ...
  def test_result
    elapsed_time = Benchmark.realtime { work(disable_bar: true) }
  ...
  # def test_profile
  #   result = RubyProf::Profile.profile { work(disable_gc: true, disable_bar: true) }
  #
