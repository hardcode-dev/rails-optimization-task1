...
Удалось улучшить метрику системы: 
 ...
 - до 0.19 секнды при 50_000 строк 
 
 - с больше 100 секунд при 100_000 строк
 - до 0.43 секнды при 100_000 строк 
  
При 100_000 строк выполнение программы занимает меньше 1 секунды.  

Уложиться в заданный бюджет обозначенный в ДЗ не получсилось.
Парсинг полного объема данных занимает ~36 секунд.
