...
- построил ассимптотику, код запуска:
  ...
  Зависимость нелинейная, похоже на квадратичную. Используя квадратичное уравнение по двум точкам 50000 и 100000
...
- обработал rubocop-performance, тест проходит:
  ...
  изменения по большей части синткасические сахарные, ушла лишние сложения строк и переменных, поэтому время работы сократилось только на 10%.
