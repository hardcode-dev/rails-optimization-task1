...
Выполнение программы снизилось до ~50 секунд на полном объеме данных.
Удалось улучшить метрику системы: 
 - с 72 секунды при 50_000 строк
 - до 0.24 секнды при 50_000 строк 
 
Уложиться в заданный бюджет получсилось. При 100_000 строк выполнение программы занимает ~1 секунду, но не больше 2. 
На полном объеме данных не удалось уложиться в 30 секунд, как было указано в ДЗ.
