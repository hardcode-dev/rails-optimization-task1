...
Для защиты от потери достигнутого прогресса при дальнейших изменениях программы написан тест на соблюдение метрики (30 секунд на работу программы с файлом `data_large.txt` на 3_250_940 строк) и тест на соблюдение метрики при работе с файлом `data_twice_large.txt`, имеющим в два раза больше строк (сами файлы под контроль git не добавлял).
