...
def work(file)
  ...
  file_lines.each do |line|
    ...
    sessions << parse
    user_sessions_hash[parse['user_id']] ||= []
    user_sessions_hash[parse['user_id']] << parse
  end
  ...
  users.each do |user|
    user_object = User.new(attributes: user, sessions: user_sessions_hash[user['id']])
